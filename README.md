...
Este perfil reunirá proyectos con documentación clara, instrucciones de reproducción y resultados verificables. Mis líneas de trabajo principales son:
...
- **Laboratorio de red empresarial:** diseño y documentación de una red segmentada y escalable.
- **Automatización para soporte TI:** scripts de Python para inventario, diagnósticos o tareas operativas.
- **Base de conocimiento de soporte:** procedimientos claros para resolver incidentes frecuentes.

Cada proyecto publicado incluirá propósito, arquitectura o enfoque, tecnologías utilizadas, evidencias y pasos para ejecutarlo.

## Formación

- Ingeniería en Tecnologías de la Información e Innovación Digital — Universidad Tecnológica de Tula-Tepeji (en curso).
- Profesional Técnico-Bachiller en Informática — especialización en Enrutamiento y Conmutación en Redes.
